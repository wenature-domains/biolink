...
<div class="container">
    <div class="d-flex flex-column align-items-center">
        ...
        <!-- <?php if(settings()->register_is_enabled): ?>
            <div class="text-center grass-text-white mt-4">
                <?= sprintf(language()->login->display->register, '<a class="grass-text-white" href="' . url('register') . '" class="font-weight-bold">' . language()->login->display->register_help . '</a>') ?></a>
            </div>
        <?php endif ?> -->
    </div>
</div>
