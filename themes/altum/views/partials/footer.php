...
<footer class="d-print-none footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-4 mb-sm-0">
                <div class="mb-2">
                    <a class="h5 p-0" href="<?= url() ?>">
                        <img style="width: 200px" src="<?= SITE_URL . UPLOADS_URL_PATH . 'logo/logo-white.png' ?>" class="img-fluid" alt="<?= language()->global->accessibility->logo_alt ?>" />
                        <!-- <?= settings()->title ?> -->
                    </a>
                </div>
            </div>
                        ...
                        document.querySelectorAll('[data-choose-theme-style]').forEach(theme => {
                            ...
                            theme.addEventListener('click', event => {
                                ...
                                switch(chosen_theme_style) {
                                    case 'dark':
                                        css.setAttribute('href', <?= json_encode(SITE_URL . ASSETS_URL_PATH . 'css/' . \Altum\ThemeStyle::$themes['dark']['file'] . '?v=' . time()) ?>);
                                    ...
                                    case 'light':
                                        css.setAttribute('href', <?= json_encode(SITE_URL . ASSETS_URL_PATH . 'css/' . \Altum\ThemeStyle::$themes['light']['file'] . '?v=' . time()) ?>);
            ...
            <div class="col-12 col-sm-4 mb-4 mb-sm-0" style="display: flex; align-items: center">
                ...
                <div class="mb-2">
                    ...
                    <?php endforeach ?>
                    <a href="https://github.com/wenature-domains">GitHub</a>
                    <div class="mt-2"><?= sprintf(language()->global->footer->copyright, '', 'reNATUREecology') ?></div>
                </div>
